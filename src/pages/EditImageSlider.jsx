...
export const EditImageSlider = () => {
    ...
    const fetchSlides = async () => {
      ...
      try {
        const { data } = await axios.get(
          "https://milkdairybackendaws-production.up.railway.app/api/v1/new-offer/get-all-offers",
      ...
      if (formData._id) {
        ...
        if (isFileModified) {
          response = await axios.post(
            `https://milkdairybackendaws-production.up.railway.app/api/v1/new-offer/edit-offer/${formData._id}`,
            formData,
            {
              withCredentials: true,
        ...
        const response = await axios.post(
          "https://milkdairybackendaws-production.up.railway.app/api/v1/new-offer/add-new-offer",
          formData,
          {
            withCredentials: true,
            headers: { "Content-Type": "multipart/form-data" },
  ...
  const handleDelete = async (_id) => {
    try {
      const response = await axios.post(
        `https://milkdairybackendaws-production.up.railway.app/api/v1/new-offer/delete-offer/${_id}`,
        {},
        {
          withCredentials: true,
          headers: { "Content-Type": "multipart/form-data" },
