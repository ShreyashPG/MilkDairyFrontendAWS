...
export const AdminReport = () => {
  ...
  useEffect(() => {
    const fetchBranches = async () => {
      try {
        const response = await axios.get("https://milkdairybackendaws-production.up.railway.app/api/v1/branch/get-branches-for-customer", { withCredentials: true }); // Adjust API URL
